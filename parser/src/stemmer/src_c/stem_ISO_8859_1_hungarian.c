...
static int r_mark_regions(struct SN_env * z) {
    ...
    {   int c = z->c; /* or, line 51 */
        ...
        while(1) { /* goto, line 48 */
            int c = z->c;
            if (!(out_grouping(z, g_v, 97, 252))) goto lab2;
            z->c = c;
            break;
        lab2:
            z->c = c;
    ...
    lab1:
        z->c = c;
        if (!(out_grouping(z, g_v, 97, 252))) return 0;
...
static int r_v_ending(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 1:
            {   int ret;
                ret = slice_from_s(z, 1, s_0); /* <-, line 62 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret;
                ret = slice_from_s(z, 1, s_1); /* <-, line 63 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_undouble(struct SN_env * z) {
    ...
    z->bra = z->c; /* ], line 73 */
    {   int ret;
        ret = slice_del(z); /* delete, line 73 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
static int r_case_special(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 1:
            {   int ret;
                ret = slice_from_s(z, 1, s_2); /* <-, line 117 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret;
                ret = slice_from_s(z, 1, s_3); /* <-, line 118 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret;
                ret = slice_from_s(z, 1, s_4); /* <-, line 119 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_case_other(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 3:
            {   int ret;
                ret = slice_from_s(z, 1, s_5); /* <-, line 127 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret;
                ret = slice_from_s(z, 1, s_6); /* <-, line 128 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_plural(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 1:
            {   int ret;
                ret = slice_from_s(z, 1, s_7); /* <-, line 143 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret;
                ret = slice_from_s(z, 1, s_8); /* <-, line 144 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
...
static int r_owned(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 1:
            {   int ret;
                ret = slice_del(z); /* delete, line 155 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret;
                ret = slice_from_s(z, 1, s_9); /* <-, line 156 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret;
                ret = slice_from_s(z, 1, s_10); /* <-, line 157 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
        ...
        case 5:
            {   int ret;
                ret = slice_from_s(z, 1, s_11); /* <-, line 159 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret;
                ret = slice_from_s(z, 1, s_12); /* <-, line 160 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
        ...
        case 8:
            {   int ret;
                ret = slice_from_s(z, 1, s_13); /* <-, line 162 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
...
static int r_sing_owner(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 2:
            {   int ret;
                ret = slice_from_s(z, 1, s_14); /* <-, line 170 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret;
                ret = slice_from_s(z, 1, s_15); /* <-, line 171 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
        ...
        case 5:
            {   int ret;
                ret = slice_from_s(z, 1, s_16); /* <-, line 173 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret;
                ret = slice_from_s(z, 1, s_17); /* <-, line 174 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
        ...
        case 10:
            {   int ret;
                ret = slice_from_s(z, 1, s_18); /* <-, line 178 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
        ...
        case 12:
            {   int ret;
                ret = slice_del(z); /* delete, line 180 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
        ...
        case 14:
            {   int ret;
                ret = slice_from_s(z, 1, s_20); /* <-, line 182 */
                if (ret < 0) return ret;
            }
            break;
        case 15:
            {   int ret;
                ret = slice_from_s(z, 1, s_21); /* <-, line 183 */
                if (ret < 0) return ret;
            }
            break;
        case 16:
            {   int ret;
                ret = slice_del(z); /* delete, line 184 */
                if (ret < 0) return ret;
            }
            break;
        case 17:
        ...
        case 18:
            {   int ret;
                ret = slice_del(z); /* delete, line 186 */
                if (ret < 0) return ret;
            }
            break;
        case 19:
            {   int ret;
                ret = slice_from_s(z, 1, s_22); /* <-, line 187 */
                if (ret < 0) return ret;
            }
            break;
        case 20:
            {   int ret;
                ret = slice_from_s(z, 1, s_23); /* <-, line 188 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_plur_owner(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 2:
            {   int ret;
                ret = slice_from_s(z, 1, s_24); /* <-, line 195 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret;
                ret = slice_from_s(z, 1, s_25); /* <-, line 196 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
        ...
        case 6:
            {   int ret;
                ret = slice_del(z); /* delete, line 199 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret;
                ret = slice_from_s(z, 1, s_26); /* <-, line 200 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret;
                ret = slice_from_s(z, 1, s_27); /* <-, line 201 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int ret;
                ret = slice_del(z); /* delete, line 202 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
        ...
        case 11:
            {   int ret;
                ret = slice_del(z); /* delete, line 204 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   int ret;
                ret = slice_from_s(z, 1, s_28); /* <-, line 205 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            {   int ret;
                ret = slice_from_s(z, 1, s_29); /* <-, line 206 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
        ...
        case 18:
            {   int ret;
                ret = slice_from_s(z, 1, s_30); /* <-, line 211 */
                if (ret < 0) return ret;
            }
            break;
        case 19:
            {   int ret;
                ret = slice_from_s(z, 1, s_31); /* <-, line 212 */
                if (ret < 0) return ret;
            }
            break;
        case 20:
            {   int ret;
                ret = slice_del(z); /* delete, line 214 */
                if (ret < 0) return ret;
            }
            break;
        case 21:
            {   int ret;
                ret = slice_del(z); /* delete, line 215 */
                if (ret < 0) return ret;
            }
            break;
        case 22:
            {   int ret;
                ret = slice_from_s(z, 1, s_32); /* <-, line 216 */
                if (ret < 0) return ret;
            }
            break;
        case 23:
            {   int ret;
                ret = slice_from_s(z, 1, s_33); /* <-, line 217 */
                if (ret < 0) return ret;
            }
            break;
        case 24:
        ...
        case 25:
            {   int ret;
                ret = slice_del(z); /* delete, line 219 */
                if (ret < 0) return ret;
            }
            break;
        case 26:
            {   int ret;
                ret = slice_del(z); /* delete, line 220 */
                if (ret < 0) return ret;
            }
            break;
        case 27:
            {   int ret;
                ret = slice_from_s(z, 1, s_34); /* <-, line 221 */
                if (ret < 0) return ret;
            }
            break;
        case 28:
            {   int ret;
                ret = slice_from_s(z, 1, s_35); /* <-, line 222 */
                if (ret < 0) return ret;
            }
            break;
        case 29:
            {   int ret;
                ret = slice_del(z); /* delete, line 223 */
                if (ret < 0) return ret;
            }
            break;
    }
...
extern int hungarian_ISO_8859_1_stem(struct SN_env * z) {
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 231 */
        {   int ret = r_instrum(z);
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 232 */
        {   int ret = r_case(z);
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 233 */
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 236 */
        {   int ret = r_owned(z);
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 237 */
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 238 */
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 239 */
        {   int ret = r_plural(z);
